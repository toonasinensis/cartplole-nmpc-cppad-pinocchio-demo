...
interface__msg__Torque__create()
{
  ...
  interface__msg__Torque * msg = (interface__msg__Torque *)allocator.allocate(sizeof(interface__msg__Torque), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interface__msg__Torque));
  bool success = interface__msg__Torque__init(msg);
  if (!success) {
...
interface__msg__Torque__destroy(interface__msg__Torque * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interface__msg__Torque__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
interface__msg__Torque__Sequence__init(interface__msg__Torque__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface__msg__Torque * data = NULL;

  if (size) {
    data = (interface__msg__Torque *)allocator.zero_allocate(size, sizeof(interface__msg__Torque), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interface__msg__Torque__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interface__msg__Torque__fini(&data[i - 1]);
      }
...
interface__msg__Torque__Sequence__fini(interface__msg__Torque__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interface__msg__Torque__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interface__msg__Torque__Sequence * array = (interface__msg__Torque__Sequence *)allocator.allocate(sizeof(interface__msg__Torque__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interface__msg__Torque__Sequence__init(array, size);
  if (!success) {
...
interface__msg__Torque__Sequence__destroy(interface__msg__Torque__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interface__msg__Torque__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interface__msg__Torque__Sequence__are_equal(const interface__msg__Torque__Sequence * lhs, const interface__msg__Torque__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interface__msg__Torque__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interface__msg__Torque__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interface__msg__Torque);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interface__msg__Torque * data =
      (interface__msg__Torque *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interface__msg__Torque__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interface__msg__Torque__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interface__msg__Torque__copy(
