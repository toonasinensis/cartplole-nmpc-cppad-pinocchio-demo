...
#include "interface/msg/detail/torque__rosidl_typesupport_fastrtps_c.h"
...
using _Torque__ros_msg_type = interface__msg__Torque;
...
size_t get_serialized_size_interface__msg__Torque(
  const void * untyped_ros_message,
...
static uint32_t _Torque__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__Torque(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface
size_t max_serialized_size_interface__msg__Torque(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Torque__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__Torque(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, msg, Torque)() {
