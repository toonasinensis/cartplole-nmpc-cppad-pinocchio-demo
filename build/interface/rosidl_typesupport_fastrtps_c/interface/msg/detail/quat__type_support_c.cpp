...
#include "interface/msg/detail/quat__rosidl_typesupport_fastrtps_c.h"
...
using _Quat__ros_msg_type = interface__msg__Quat;
...
static uint32_t _Quat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__Quat(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface__msg__Quat;
    is_plain =
      (
...
static size_t _Quat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__Quat(
